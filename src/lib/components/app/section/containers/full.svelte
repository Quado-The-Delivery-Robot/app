...
<div class="h-full rounded-lg p-4 border border-backgroundSecondary bg-background flex items-center justify-start gap-4 snap-start w-[290px] shrink-0" style="background-color: {colors[0]};">
    {#if "image" in data}
    ...
    <div class="h-full py-1.5 flex flex-col justify-between items-start">
        ...
        <p class="text-sm text-ellipsis" style="color: {colors[2]};">{subtext}</p>
    </div>
</div>
